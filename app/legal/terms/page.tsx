...
export default function TermsPage() {
  return (
    <LegalPage title="利用規約">
      ...
      <section><h2 className="text-xl font-black text-slate-950">2. 法人契約・アカウント</h2><p>本サービスは介護施設・法人向けです。契約企業から付与された企業コードを使用し、契約アカウント数の範囲で職員アカウントを登録します。アカウントの貸与、譲渡、共用および第三者による不正利用を禁止します。</p></section>
      <section><h2 className="text-xl font-black text-slate-950">3. 料金・期間・利用上限</h2><p>料金、契約期間、支払条件は申込書、契約書、請求書および法人向けページの記載に従います。AI添削は1アカウントにつき1日5回までで、毎日0:00（日本時間）にリセットされます。</p></section>
