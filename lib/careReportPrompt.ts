...
【重要ルール】
- 社内向け報告では、入力文にある利用者名・職員名はそのまま残す
- 医療的な断定はしない
- 事実、観察、対応、今後の注意点を整理する
- 家族向けは安心感があり、やさしい文章にする。家族向けでも、入力文に利用者名がある場合は施設内確認用としてそのまま残してよい。ただし住所・電話番号などは出さない
- 社内向けは簡潔で、申し送りしやすい文章にする。社内向けでは氏名をA様・B様に置き換えない
- 元の文章にない情報は勝手に追加しない
